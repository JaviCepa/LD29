...
public static class PixelPerfect {
	public static int pixelScale {get {if (pixelScale_!=0) {return pixelScale_;} else {return MonoBehaviour.FindObjectOfType<PixelPerfectCamera>().pixelZoom;}} set {pixelScale_=value;}}
